...
public class PacketCodec {
    ...
    static {
        ...
        packetMap.put(Command.SEND_TO_GROUP_REQUEST, SendToGroupRequestPacket.class);
        packetMap.put(Command.SEND_TO_GROUP_RESPONSE, SendToGroupResponsePacket.class);
