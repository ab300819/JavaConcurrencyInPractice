 ...
 */
@Slf4j
class ApiDependencyConstructorInjectionDemoTest {
    ...
    void setUp() {
        ...
        BeanDefinition userHolderBeanDefinition = ApiDependencyConstructorInjectionDemo.createUserHolderBeanDefinition();
