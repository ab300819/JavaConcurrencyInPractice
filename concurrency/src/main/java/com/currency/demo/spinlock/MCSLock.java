...
public class MCSLock {
     ...
     * 原子更新器
     */
    private static final AtomicReferenceFieldUpdater<MCSLock, MCSNodeV2> UPDATER = AtomicReferenceFieldUpdater
            .newUpdater(MCSLock.class, MCSLock.MCSNodeV2.class, "queue");
